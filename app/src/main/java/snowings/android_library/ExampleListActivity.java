package snowings.android_library;
...
/**
 * An activity representing a list of Examples. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link ExampleDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link ExampleListFragment} and the item details
 * (if present) is a {@link ExampleDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link ExampleListFragment.Callbacks} interface
...
public class ExampleListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.example_detail_container) != null) {
            ...
            ((ExampleListFragment) getFragmentManager()
    ...
    /**
     * Callback method from {@link ExampleListFragment.Callbacks}
